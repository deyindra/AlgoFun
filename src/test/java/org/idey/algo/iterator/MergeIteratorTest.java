...
public class MergeIteratorTest {
    ...
    public <T extends Comparable<T>> void successIteratorTest(MergeIterator<T> mergeIterator, Iterator<T> expectedIterator){
        Assert.assertTrue(mergeIterator.hasNext()==expectedIterator.hasNext());
    ...
    private Object[] successIteratorTestParam() {
        return new Object[]{
                ...
                new Object[]{new MergeIterator<>(Arrays.asList(1,4).iterator(),
                        Arrays.asList(2,3).iterator()), Arrays.asList(1,2,3,4).iterator()},
                new Object[]{new MergeIterator<>(Collections.singleton((Integer)null).iterator(),
                            Arrays.asList(null,1,4).iterator(),
                            Arrays.asList(2,3).iterator()), Arrays.asList(null,null,1,2,3,4).iterator()},
                new Object[]{new MergeIterator<Integer>(Collections.emptyIterator(), Collections.emptyIterator()), Collections.emptyIterator()}
        };
    }
